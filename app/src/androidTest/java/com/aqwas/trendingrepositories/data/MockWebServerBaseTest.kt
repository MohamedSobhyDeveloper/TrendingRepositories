package com.aqwas.trendingrepositories.data
...
abstract class MockWebServerBaseTest {
    ...
    fun provideTestApiService(): TrendingService {
        return Retrofit.Builder().baseUrl(mockServer.url("/")).addConverterFactory(
            GsonConverterFactory.create())
            .client(OkHttpClient.Builder().build()).build().create(TrendingService::class.java)
    }
}